...
class Database {
    ...
    #createPool() {
        this.#pool = mysql.createPool({
            ...
            queueLimit: 0,
            ssl: {
                rejectUnauthorized: false // importante para conexões seguras em ambientes de deploy (ex: render)
            }
        });
    }
...
// função para inicializar o banco de dados e criar as tabelas automaticamente se não existirem
